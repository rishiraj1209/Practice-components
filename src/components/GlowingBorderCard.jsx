    ...
    <div className='bg-gray-950 h-screen w-full py-20'>
        <div className='relative w-80 h-96 mx-auto rounded-xl overflow-hidden cursor-pointer p-px bg-gray-900 text-gray-800 shadow-lg backdrop-blur-md'>
            <div className='relative z-10 flex flex-col items-center bg-gray-900/70 h-full w-full text-white rounded-[11px] p-8'>
                ...
                <h2 className='text-indigo-500 text-sm font-medium mb-6'>Software Developer</h2>
                <p className='text-center text-sm text-gray-400'>Passionate about clean code, scalable systems, solving real-world problems with elegant software.</p>
                <div className='flex items-center space-x-4 mt-6 text-slate-400'>
                    <a href="#" target="_blank" className='hover:-translate-y-0.5 transition duration-200'>
